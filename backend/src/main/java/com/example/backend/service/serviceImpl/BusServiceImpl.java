...
public class BusServiceImpl  implements BusService {
    ...
    public List<BusDTO> getAllBuses() {
       List<BusDTO> busList = modelMapper.map(busRepository.findAll(), new org.modelmapper.TypeToken<List<BusDTO>>() {}.getType());
       return busList;
    }
    @Override
    public int updateBusStatus(String busNumber, Status status) {
       ...
       if (bus == null) {
           throw new RuntimeException("Bus with number " + busNumber + " not found.");
       }
